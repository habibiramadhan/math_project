        ...
        <div class="flex">
            ...
            <nav class="side-nav">
                ...
                <ul>
                    ...
                    <li>
                        <a href="{{ route('soals.index') }}" class="side-menu side-menu">
                            <div class="side-menu__icon"> <i data-feather="inbox"></i> </div>
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Category</a> </div>
                    <!-- END: Breadcrumb -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
                        <button class="button text-white bg-theme-1 shadow-md mr-2"><a href="{{ route('categories.create') }}">Tambah Category</a></button>
                    </div>
                    <!-- BEGIN: Data List -->
                        ...
                        <table class="table table-report -mt-2">
                            ...
                            @foreach ($categories as $category)
                                <tr class="intro-x">
                                    ...
                                    <td>
                                        <p class="font-medium whitespace-no-wrap">{{$category->name}}</p>
                                    </td>
                                    <td class="w-40">
                                        <p class="font-medium whitespace-no-wrap">{{$category->user->name}}</p>  
                                    </td>
