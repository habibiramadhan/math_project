    ...
    <body class="app">
        <div class="flex">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Category</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Create Category</a></div>
                    <!-- END: Breadcrumb -->
                    ...
                    <div class="intro-y col-span-24 lg:col-span-12">
                        ...
                        <div class="intro-y box p-5">
                            ...
                            <div class="form-group @if($errors->has('name')) has-error @endif">
                                {!! Form::label('Name') !!}
                                {!! Form::text('name', null, ['class' => 'input w-full border mt-2', 'placeholder' => 'Input Name']) !!}
                                @if ($errors->has('name'))
