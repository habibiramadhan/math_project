    ...
    <body class="app">
        <div class="flex">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Materi</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Edit Materi</a></div>
                    <!-- END: Breadcrumb -->
                    ...
                    <div class="intro-y col-span-24 lg:col-span-12">
                        ...
                        <div class="intro-y box p-5">
                            <div class="form-group @if($errors->has('thumbnail')) has-error @endif">
                                ...
                                {!! Form::text('thumbnail', $post->thumbnail, ['class' => 'input w-full border mt-2', 'placeholder' => 'Thumbnail']) !!}
                            ...
                            <div class="form-group @if($errors->has('title')) has-error @endif">
                                {!! Form::label('Title') !!}
                                {!! Form::text('title', $post->title, ['class' => 'input w-full border mt-2', 'placeholder' => 'Input Title']) !!}
                                @if ($errors->has('title'))
                            ...
                            <div class="form-group @if($errors->has('sub_title')) has-error @endif">
                                ...
                                {!! Form::text('sub_title', $post->sub_title, ['class' => 'input w-full border mt-2', 'placeholder' => 'Sub Title']) !!}
                            ...
                            <div class="">
                                {!! Form::label('Category') !!}
                                {!! Form::select('category_id[]', $categories, $post->categories, ['class' => 'tail-select w-full', 'id' => 'category_id', 'multiple' => 'multiple']) !!}
