        ...
        <div class="flex">
            ...
            <nav class="side-nav">
                ...
                <ul>
                    ...
                    <li>
                        <a href="{{ route('categories.index') }}" class="side-menu side-menu">
                    ...
                    <li>
                        <a href="{{ route('soals.index') }}" class="side-menu side-menu--active">
                            <div class="side-menu__icon"> <i data-feather="inbox"></i> </div>
            ...
            <div class="content">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
                        <button class="button text-white bg-theme-1 shadow-md mr-2"><a href="{{ route('soals.create') }}">Tambah soal</a></button>
                    </div>
                    <!-- BEGIN: Data List -->
